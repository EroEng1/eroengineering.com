...
<nav id="menu" class="navbar navbar-default navbar-fixed-top">
  <div class="container"> 
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand page-scroll" href="#page-top">Ero Engineering</a>
      <div class="phone"><span>Call Today</span>+94 711 259 941</div>
    </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 col-md-offset-2 intro-text">
            <h1>Interior Designing<br>
              & Home Decorating</h1>
            <p>We construct & stylish your dream home for you.</p>
...
<div id="about">
  <div class="container">
    <div class="row">
      <div class="col-xs-12 col-md-6"> <img src="img/abt.jpg" class="img-responsive" alt=""> </div>
      <div class="col-xs-12 col-md-6">
        <div class="about-text">
          <h2>Who We Are</h2>
          <p>We have professional interior home designers and engineers. We construct, remodel and stylish your home.</p>
          <h3>Why Choose Us?</h3>
    ...
    <div class="row">
      <div class="col-md-4">
        ...
        <div class="service-desc">
          ...
          <p>We design and construct your dream home.</p>
        </div>
      </div>
      <div class="col-md-4">
        ...
        <div class="service-desc">
          ...
          <p>We design and construct your home.</p>
        </div>
      </div>
      <div class="col-md-4">
        ...
        <div class="service-desc">
          ...
          <p>If you want to remodel your bathroom we are the best for that.</p>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-4">
        <div class="service-media"> <img src="img/services/service-7.jpg" alt=" "> </div>
        <div class="service-desc">
          <h3>Kitchen Remodels</h3>
          <p>We make your old kitchen to a modern kitchen designing newest pantry cupboard styles for you.</p>
        </div>
      </div>
      <div class="col-md-4">
        ...
        <div class="service-desc">
          <h3>Windows & Doors</h3>
          <p>We do alluminium fabrications and make doors and windows with high durability.</p>
        </div>
      </div>
      <div class="col-md-4">
        ...
        <div class="service-desc">
          <h3>Hand Rails</h3>
          <p>We have a large stock with different hand rail materials to fulfill your dream.</p>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="col-md-4">
        <div class="testimonial">
          ...
          <div class="testimonial-content">
            <p>"They make our kitchen more stylish"</p>
            <div class="testimonial-meta"> - Mihika Weerasinghe </div>
          </div>
        </div>
      </div>
      <div class="col-md-4">
  ...
  <div class="container">
    ...
    <div class="col-md-3 col-md-offset-1 contact-info">
      <div class="contact-item">
        <h4>Contact Info</h4>
        <p><span>Address</span>295/6B,<br>
          Bollatha, Ganemulla</p>
      </div>
      <div class="contact-item">
        <p><span>Phone</span> +94 711259941</p>
      </div>
      <div class="contact-item">
        <p><span>Email</span> eroengineeringsl@gmail.com</p>
      </div>
    </div>
    <div class="col-md-12">
      <div class="row">
